...
# Circle parameters
# Backend processes 320x240 images, so these coordinates are scaled down by 2 relative to 640x480
CIRCLE_CENTER = (160, 120)  # Center of the virtual object (320/2, 240/2)
CIRCLE_RADIUS = 25          # 50 / 2
WARNING_BAND = 25           # 50 / 2
